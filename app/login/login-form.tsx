...
export function FormLogin({ pesanGalat }: { pesanGalat?: string }) {
  ...
  return (
    <div className="w-full max-w-sm animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="rounded-2xl border border-border/60 bg-card/90 p-6 shadow-xl backdrop-blur-sm sm:p-8">
        <div className="mb-6 flex flex-col items-center gap-2 text-center">
          ...
          <div>
            <h1 className="text-xl font-semibold text-foreground">SIGAP</h1>
